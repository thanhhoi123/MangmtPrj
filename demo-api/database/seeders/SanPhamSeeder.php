    ...
    public function run()
    {
        ...
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/1.png'),
            ],
        ...
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/2.png'),
            ],
        )->categories()->attach([1]);
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/3.png'),
            ],
        )->categories()->attach([1]);
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/4.png'),
            ],
        )->categories()->attach([1]);
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/5.png'),
            ],
        ...
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/6.png'),
            ],
        )->categories()->attach([2]);
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/7.png'),
            ],
        )->categories()->attach([2]);
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/8.png'),
            ],
        )->categories()->attach([3]);
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/9.png'),
            ],
        )->categories()->attach([3]);
        SanPham::create(
            [
                ...
                'img_link' => basename('app/products/10.png'),
            ],
        )->categories()->attach([3]);
    }
}
